...
public class TestMarkdownParsing {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < testPoints.size(); i++) {
            ...
            System.out.println("描述：" + point.getDescription().substring(0, Math.min(100, point.getDescription().length())) + "...");
